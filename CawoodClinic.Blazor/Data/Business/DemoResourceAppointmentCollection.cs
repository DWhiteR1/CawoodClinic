...
using System.Linq;
    ...
    public static partial class DemoResourceDemoAppointmentCollection
{
        public static List<DemoAppointment> GetDemoAppointments()
        {
            DateTime date = DateTime.Now.Date;
            var dataSource = new List<DemoAppointment>() {
                new DemoAppointment {
                    Accepted = true,
