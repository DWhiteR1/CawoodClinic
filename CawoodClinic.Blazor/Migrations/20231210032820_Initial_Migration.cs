        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FormatOfMeasurement = table.Column<string>(type: "TEXT", maxLength: 75, nullable: true),
                    IsDeleted = table.Column<bool>(type: "INTEGER", nullable: false),
                    DataTypeOfMeasurement = table.Column<string>(type: "TEXT", maxLength: 30, nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "INTEGER", nullable: false)
                        .Annotation("Sqlite:Autoincrement", true),
                    NameSpace = table.Column<string>(type: "TEXT", maxLength: 50, nullable: false),
                    ParentId = table.Column<int>(type: "INTEGER", nullable: false),
                    PageName = table.Column<string>(type: "TEXT", maxLength: 255, nullable: false),
                    MenuName = table.Column<string>(type: "TEXT", maxLength: 255, nullable: false),
                    IconName = table.Column<string>(type: "TEXT", maxLength: 255, nullable: false),
                    IsEnabled = table.Column<bool>(type: "INTEGER", nullable: false),
                    MenuOrder = table.Column<int>(type: "INTEGER", nullable: false),
                    MenuToggleEnabled = table.Column<bool>(type: "INTEGER", nullable: false),
                    LastUpdatedDeviceId = table.Column<Guid>(type: "TEXT", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IdNumber = table.Column<string>(type: "TEXT", maxLength: 25, nullable: true),
                    ContactNumber = table.Column<string>(type: "TEXT", maxLength: 25, nullable: true),
                    EmailAddress = table.Column<string>(type: "TEXT", maxLength: 255, nullable: true),
                    PhysicalAddress = table.Column<string>(type: "TEXT", maxLength: 255, nullable: true),
                    RegionId = table.Column<Guid>(type: "TEXT", nullable: true),
                    IsDeleted = table.Column<bool>(type: "INTEGER", nullable: false)
                },
                constraints: table =>
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AppointmentReason = table.Column<string>(type: "TEXT", maxLength: 255, nullable: true),
                    AppointmentStatusId = table.Column<Guid>(type: "TEXT", nullable: false),
                    AppointmentNotes = table.Column<string>(type: "TEXT", maxLength: 500, nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Appointments_AppointmentStatus",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "TEXT", nullable: false),
                    PatientId = table.Column<Guid>(type: "TEXT", nullable: false),
                    MeasurementTypeId = table.Column<Guid>(type: "TEXT", nullable: false),
                    DateOfMeasurement = table.Column<DateTime>(type: "TEXT", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Measurement_MeasurementTypes",
                        column: x => x.MeasurementTypeId,
                        principalTable: "MeasurementTypes",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Measurement_Patients",
                        column: x => x.PatientId,
                        principalTable: "Patients",
                        principalColumn: "Id");
                });
